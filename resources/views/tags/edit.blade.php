...
<div class="dashboard-container max-w-3xl">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
        <h1 class="text-3xl font-bold text-slate-900 mb-2">✏️ Edit Tag</h1>
        <p class="text-slate-600 mb-6">Update tag information</p>
        ...
        <form action="{{ route('tags.update', $tag) }}" method="POST" class="space-y-6">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" placeholder="e.g., JavaScript, Python, Tutorial, Tips" class="form-input" value="{{ old('name', $tag->name) }}" required>
