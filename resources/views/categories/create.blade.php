...
<div class="dashboard-container max-w-3xl">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8">
        <h1 class="text-3xl font-bold text-slate-900 mb-2">➕ Create Category</h1>
        <p class="text-slate-600 mb-6">Add a new category to organize your posts</p>
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="space-y-6">
            ...
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" placeholder="e.g., Technology, Lifestyle, Business" class="form-input" value="{{ old('name') }}" required>
            </div>

            <div class="form-group">
                <label for="description" class="form-label">📝 Description (Optional)</label>
                <textarea id="description" name="description" rows="4" placeholder="Brief description of this category..." class="form-input resize-none">{{ old('description') }}</textarea>
